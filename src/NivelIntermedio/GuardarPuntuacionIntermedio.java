...
public class GuardarPuntuacionIntermedio extends javax.swing.JFrame {

    public static int PuntuacionJugadorIn;
    public static String Nombre = "";
    
    JuegoIntermedio jintermedio;
    
    public GuardarPuntuacionIntermedio() {
        initComponents();
    ...
    public void mostrarPuntuacionguardar(int puntuacion) {
        PuntuacionJugadorIn= puntuacion;
...
public void mostrarPuntuacionguardarperdio(int puntuacion) {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        Nombre= NombreingresadoFacil.getText();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GuardarPuntuacionIntermedio.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GuardarPuntuacionIntermedio().setVisible(true);
            }
        });
    }
