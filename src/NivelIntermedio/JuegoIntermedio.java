...
public class JuegoIntermedio extends javax.swing.JFrame {
    ...
    public JuegoIntermedio() {
     ...
     public void tituloventana() {
        setTitle("Partida Nivel Intermedio 2048:REVIVE");
}
    public void logicaExtra(){
                ...
                public void keyPressed(KeyEvent e) {
                    ...
                    switch (keyCode) {
                        case KeyEvent.VK_UP:
                            ...
                            if (verificarPerder()) {
                         JuegoPerdidoIntermedio perdio = new JuegoPerdidoIntermedio();
        ...
        for (int i = 0; i < matriz.length; i++) {
            for (int j = 0; j < matriz[i].length; j++) {
                ...
                celdas[i][j].setText(Integer.toString(matriz[i][j])); 
                }
            }
        }
    ...
    if (probabilidad < 0.40) {
        ...
        matriz[fila][columna] = 16;
    }
        
    }//Agregar numero 2, 4, 8, 16
        ...
        for (int i = 0; i < TAMAÑO; i++) {
            for (int j = 0; j < TAMAÑO; j++) {
                if (matriz[i][j] == 2048) {
                    ...
                    VictoriaIntermedio gano= new VictoriaIntermedio();
    ...
    return true;
        ...
        puntuacionLabel.setText("Puntuación: " + Puntuacion); // Actualizar el texto de la etiqueta
    }
    ...
    private void initComponents() {
        ...
        jButton1.setFont(new java.awt.Font("Trebuchet MS", 1, 17)); // NOI18N
        jButton1.setForeground(new java.awt.Color(255, 255, 255));
        jButton1.setText("| |");
        jButton1.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(85, 47, 112), 3));
        jButton1.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        jButton1.setMultiClickThreshhold(2L);
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 10, 60, 60));
        ...
        getContentPane().add(tableropanel, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 100, 400, 400));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        PausaIntermedio AccederMenu= new PausaIntermedio(this);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JuegoIntermedio.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
